            ...
            <div class="navbar__container">
                ...
                <ul class="navbar__menu">
                    ...
                    <li class="navbar__btn">
                        <a href="/table.php" class="button__sign"> Find Prime numbers! </a>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <main class="main">
        <div class="main__container">
            <div class="main__content">
                <h1>Nospiez pogu lai sakt!</h1>
                <button class="main__btn"><a href="/table.php">Find Prime numbers!</a></button>
            </div>
            <div class="main__img__container">
                <img src="/img/phplogo.png" id="main__img" />
            </div>
        </div>
    </main>
    <!-- main -->
